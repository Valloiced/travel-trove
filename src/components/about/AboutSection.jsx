export default function AboutSection() {
    return (
        <div className="flex flex-col justify-center items-center py-20 gap-20">
            ...
            <div className="flex flex-col gap-4 w-3/4 max-w-screen-xl max-md:w-full max-md:px-2">
            ...
            <div className="flex flex-row justify-between w-3/4 max-w-screen-xl max-lg:flex-col max-lg:gap-8 max-md:w-full max-md:px-2">
                <h2 className="w-1/2 font-gothicA1 font-semibold text-xl">What Travel Trove Offers</h2>
                <ul className="flex flex-col list-none gap-12 w-1/2 max-lg:w-full">
                    <AboutOffersList 
                        title="Low Rates"
